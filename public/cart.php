			...
			if(substr($name, 0, 8) == 'product_'){
				...
				while($row = fetch_array($query)){
					...
					<tr>	
						...
						<a class='btn btn-success' href="cart.php?add={$row['id']}"><span class='glyphicon glyphicon-plus'></a>
						<a class='btn btn-danger' href="cart.php?delete={$row['id']}"><span class='glyphicon glyphicon-remove'></a>
						</td>
					</tr>
