                    ...
                    <form name="sentMessage" id="contactForm" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="name" name="subject" class="form-control" placeholder="Subject *" id="phone" required data-validation-required-message="Please enter subjcet.">
                                    <p class="help-block text-danger"></p>
                                </div>
                            </div>
                            <div class="col-md-6">
